...
before packages are loaded."
  ...
  ;; setup load path
  (setq site-lisp-dir
        (expand-file-name "site-lisp" "~/.emacs.rc"))

  (setq config-dir
        (expand-file-name "config" "~/.emacs.rc"))

  (add-to-list 'load-path site-lisp-dir)
  (add-to-list 'load-path config-dir)

  ;; load all files in defun dir
  (setq defuns-dir (expand-file-name "defuns" "~/.emacs.rc"))
